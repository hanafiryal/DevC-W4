  ...
  <!-- End Menubar -->
   ...
   <!-- container -->
    ...
    <?php
      $tgl=date('Y-m-d');
    ?>
      <h3 class="mb-4">Input Record Transaksi</h3>
        <form action="transaksi.input.php" method="post">
          <table border="0">
          <tr>
              <td>Tanggal Beli</td>
              <td>: <input name="tgl_beli" type="text" size="20" maxlength="20" value="<?php echo $tgl; ?>"></td>
            </tr>
            <tr>
              <td>Kode Transaksi</td>
              <td>: <input name="kd_transaksi" type="text" size="10" maxlength="10" value=""></td>
            </tr>
            <tr>
              <td>ID Karyawan</td>
              <td>: <input name="id_karyawan" type="text" size="13" maxlength="13" value="w0"></td>
            </tr>
            <tr>
              <td>Kode Pembeli</td>
              <td>: <input name="kd_pembeli" type="text" size="10" maxlength="10" value="n"></td>
            </tr>
            <tr>
              <td>Kode Menu</td>
            ...
            <tr>
              <td>Harga</td>
              <td>: <input name="harga" type="text" size="10" maxlength="10"></td>
            </tr>
            <tr>
              <td>Jumlah Beli</td>
              <td>: <input name="jumlah_beli" type="text" size="10" maxlength="10"></td>
            </tr>
            <tr>
              <td>Total Bayar</td>
              <td>: <input name="total_bayar" type="text" size="10" maxlength="10"></td>
            </tr>
            <tr>
          </table><br>
