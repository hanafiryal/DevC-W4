...
<html lang="en">
  ...
  <!-- End Menubar -->
   ...
   <!-- container -->
    <div class="container pt-4">
      <h3 class="mb-4">Form Update Menu</h3>
      <?php
      include "koneksi.php";
        $sql = mysqli_query($connection, "SELECT * FROM menu WHERE kd_menu='$_GET[kd]'");
        while($data = mysqli_fetch_array($sql)){
        ?>
        <form action="prosesupdate.menu.php" method="post">
        
          <table border="0">
          <tr>
              <td style="background-color: #e7e0dd">Kode Menu</td>
              <td>: <input name="kd_menu" type="text" size="50" maxlength="40" value="<?php echo $data['kd_menu']; ?>"></td>
            </tr>
            <tr>
              <td style="background-color: #e7e0dd">Nama Menu</td>
              <td>: <input name="nama_menu" type="text" size="30" maxlength="30" value="<?php echo $data['nama_menu']; ?>"></td>
            </tr>
            <tr> 
              <td style="background-color: #e7e0dd"> ID Supplier</td>
              <td>: <input name="id_supplier" type="text" size="10" maxlength="10" value="<?php echo $data['id_supplier']; ?>"></td>
            </tr>
            <tr>
              <td style="background-color: #e7e0dd">Harga</td>
              <td>: <input name="Harga" type="text" size="50" maxlength="40" value="<?php echo $data['Harga']; ?>"></td>
            </tr>
          </table><br>
