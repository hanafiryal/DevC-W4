...
<html lang="en">
  ...
  <!-- End Menubar -->
  <br>
          <h3 class="mb-4">Update Transaksi</h3> </br>
          <?php
            include "koneksi.php";
            $query = mysqli_query($connection,"SELECT * FROM transaksi ORDER BY kd_transaksi ASC");
          ?>
          <form action="formupdate.transaksi.php" method="post">
          ...
          <tr>
            ...
            <td><a href="formupdate.transaksi.php?hal=formupdate.transaksi&kd=<?php echo $data['kd_transaksi'];?>">Update</a></td>
          </tr>
          <?php $no++; } ?>
          <?php } ?>
          </table>
